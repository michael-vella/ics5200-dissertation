...
df = handler.create_dataset(dataset_source=DatasetSource.DUDE_GPCR, feature_type=FeatureType.ECFP, force_refresh=False)
df = handler.create_dataset(dataset_source=DatasetSource.DUDE_GPCR, feature_type=FeatureType.DGL, force_refresh=False)
df = handler.create_dataset(dataset_source=DatasetSource.DUDE_GPCR, feature_type=FeatureType.DGL_WITH_BONDS, force_refresh=False)